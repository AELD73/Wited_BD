 ...
 */
@WebServlet(name = "CursoFormHTML", urlPatterns = { "/CursoFormHTML" })
public class CursoFormHTMLServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public CursoFormHTMLServlet() {
		super();
	}
	...
	public void documentShow(List<CursoDTO> cursos, HttpServletResponse response, int key) throws IOException {
		try {
			...
			HtmlWriter.getInstance(document, fos);
